...
function Modal({ onSubmit, onOk, onCancel, review, onReview, onSetRating }) {
  ...
  return (
    <div className="fixed inset-0 bg-opacity-100 flex justify-center bg-[#1D3045]">
      <div className="w-[343px] sm:[695px] rounded-xl bg-[white] p-4">
        <div>
          ...
          {/* <Image
            ...
            className="mb-4"
          /> */}
          <StarRating onSetRating={onSetRating} />
